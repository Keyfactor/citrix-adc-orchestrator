...
For more information on [kfutil](https://github.com/Keyfactor/kfutil) check out the [docs](https://github.com/Keyfactor/kfutil?tab=readme-ov-file#quickstart)
   <details><summary>Click to expand CitrixAdc kfutil details</summary>
...
#### Manual Creation
Below are instructions on how to create the CitrixAdc store type manually in
the Keyfactor Command Portal
   <details><summary>Click to expand manual CitrixAdc details</summary>
...
1. **Download the latest Citrix Netscaler Universal Orchestrator extension from GitHub.**
    ...
    Navigate to the [Citrix Netscaler Universal Orchestrator extension GitHub version page](https://github.com/Keyfactor/citrix-adc-orchestrator/releases/latest). Refer to the compatibility matrix below to determine the asset should be downloaded. Then, click the corresponding asset to download the zip archive.
