...
// Type: com.citrix.netscaler.nitro.resource.config.lsn.lsnrtspalgsession_datachannel_binding
...
{
  public class lsnrtspalgsession_datachannel_binding : base_resource
  {
    ...
    internal override base_resource[] get_nitro_response(
      ...
      string response)
    {
      lsnrtspalgsession_datachannel_binding.lsnrtspalgsession_datachannel_binding_response datachannelBindingResponse = new lsnrtspalgsession_datachannel_binding.lsnrtspalgsession_datachannel_binding_response();
      lsnrtspalgsession_datachannel_binding.lsnrtspalgsession_datachannel_binding_response resource = (lsnrtspalgsession_datachannel_binding.lsnrtspalgsession_datachannel_binding_response) service.get_payload_formatter().string_to_resource(datachannelBindingResponse.GetType(), response);
      ...
      return (base_resource[]) resource.lsnrtspalgsession_datachannel_binding;
    }

    internal override string get_object_name() => this.sessionid;

    public static lsnrtspalgsession_datachannel_binding[] get(
      nitro_service service,
      string sessionid)
    {
      return (lsnrtspalgsession_datachannel_binding[]) new lsnrtspalgsession_datachannel_binding()
      {
        sessionid = sessionid
      }.get_resources(service, (options) null);
    }

    public static lsnrtspalgsession_datachannel_binding[] get_filtered(
      nitro_service service,
      string sessionid,
      string filter)
    {
      lsnrtspalgsession_datachannel_binding datachannelBinding = new lsnrtspalgsession_datachannel_binding();
      datachannelBinding.sessionid = sessionid;
      options option = new options();
      option.set_filter(filter);
      return (lsnrtspalgsession_datachannel_binding[]) datachannelBinding.getfiltered(service, option);
    }
    ...
    public static uint count(nitro_service service, string sessionid)
    {
      lsnrtspalgsession_datachannel_binding datachannelBinding = new lsnrtspalgsession_datachannel_binding();
      datachannelBinding.sessionid = sessionid;
      options option = new options();
      option.set_count(true);
      lsnrtspalgsession_datachannel_binding[] resources = (lsnrtspalgsession_datachannel_binding[]) datachannelBinding.get_resources(service, option);
      return resources != null && resources.Length > 0 ? resources[0].__count.Value : 0U;
    }

    public static uint count_filtered(nitro_service service, string sessionid, string filter)
    {
      lsnrtspalgsession_datachannel_binding datachannelBinding = new lsnrtspalgsession_datachannel_binding();
      datachannelBinding.sessionid = sessionid;
      options option = new options();
      option.set_count(true);
      option.set_filter(filter);
      lsnrtspalgsession_datachannel_binding[] datachannelBindingArray = (lsnrtspalgsession_datachannel_binding[]) datachannelBinding.getfiltered(service, option);
    ...
    private class lsnrtspalgsession_datachannel_binding_response : base_response
    {
      public lsnrtspalgsession_datachannel_binding[] lsnrtspalgsession_datachannel_binding = (lsnrtspalgsession_datachannel_binding[]) null;
    }
