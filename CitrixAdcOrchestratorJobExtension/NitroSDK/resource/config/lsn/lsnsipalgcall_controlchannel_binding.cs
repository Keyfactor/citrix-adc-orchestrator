...
// Type: com.citrix.netscaler.nitro.resource.config.lsn.lsnsipalgcall_controlchannel_binding
...
{
  public class lsnsipalgcall_controlchannel_binding : base_resource
  {
    ...
    internal override base_resource[] get_nitro_response(
      ...
      string response)
    {
      lsnsipalgcall_controlchannel_binding.lsnsipalgcall_controlchannel_binding_response controlchannelBindingResponse = new lsnsipalgcall_controlchannel_binding.lsnsipalgcall_controlchannel_binding_response();
      lsnsipalgcall_controlchannel_binding.lsnsipalgcall_controlchannel_binding_response resource = (lsnsipalgcall_controlchannel_binding.lsnsipalgcall_controlchannel_binding_response) service.get_payload_formatter().string_to_resource(controlchannelBindingResponse.GetType(), response);
      ...
      return (base_resource[]) resource.lsnsipalgcall_controlchannel_binding;
    }

    internal override string get_object_name() => this.callid;

    public static lsnsipalgcall_controlchannel_binding[] get(
      nitro_service service,
      string callid)
    {
      return (lsnsipalgcall_controlchannel_binding[]) new lsnsipalgcall_controlchannel_binding()
      {
        callid = callid
      }.get_resources(service, (options) null);
    }

    public static lsnsipalgcall_controlchannel_binding[] get_filtered(
      nitro_service service,
      string callid,
      string filter)
    {
      lsnsipalgcall_controlchannel_binding controlchannelBinding = new lsnsipalgcall_controlchannel_binding();
      controlchannelBinding.callid = callid;
      options option = new options();
      option.set_filter(filter);
      return (lsnsipalgcall_controlchannel_binding[]) controlchannelBinding.getfiltered(service, option);
    }
    ...
    public static uint count(nitro_service service, string callid)
    {
      ...
      lsnsipalgcall_controlchannel_binding[] resources = (lsnsipalgcall_controlchannel_binding[]) controlchannelBinding.get_resources(service, option);
    ...
    public static uint count_filtered(nitro_service service, string callid, string filter)
    {
      ...
      option.set_count(true);
      option.set_filter(filter);
      lsnsipalgcall_controlchannel_binding[] controlchannelBindingArray = (lsnsipalgcall_controlchannel_binding[]) controlchannelBinding.getfiltered(service, option);
      return controlchannelBindingArray != null && controlchannelBindingArray.Length > 0 ? controlchannelBindingArray[0].__count.Value : 0U;
    }
    ...
    private class lsnsipalgcall_controlchannel_binding_response : base_response
    {
      public lsnsipalgcall_controlchannel_binding[] lsnsipalgcall_controlchannel_binding = (lsnsipalgcall_controlchannel_binding[]) null;
    }
