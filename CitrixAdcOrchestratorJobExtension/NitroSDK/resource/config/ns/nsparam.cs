...
// Type: com.citrix.netscaler.nitro.resource.config.ns.nsparam
...
{
  public class nsparam : base_resource
  {
    ...
    private string internaluserloginField = (string) null;
    private string aftpallowrandomsourceportField = (string) null;
    private ushort?[] icaportsField = (ushort?[]) null;
    private string tcpcipField = (string) null;
    private uint? servicepathingressvlanField = new uint?();
    ...
    public string internaluserlogin
    {
      get => this.internaluserloginField;
      set => this.internaluserloginField = value;
    }

    public string aftpallowrandomsourceport
    {
      get => this.aftpallowrandomsourceportField;
      set => this.aftpallowrandomsourceportField = value;
    }

    public ushort?[] icaports
    {
      get => this.icaportsField;
      set => this.icaportsField = value;
    }

    public string tcpcip
    {
      get => this.tcpcipField;
      set => this.tcpcipField = value;
    }

    public uint? servicepathingressvlan
    {
      get => this.servicepathingressvlanField;
      set => this.servicepathingressvlanField = value;
    }
    ...
    internal override base_resource[] get_nitro_response(
      ...
      string response)
    {
      nsparam[] nsparamArray = new nsparam[1];
      nsparam.nsparam_response nsparamResponse = new nsparam.nsparam_response();
      nsparam.nsparam_response resource = (nsparam.nsparam_response) service.get_payload_formatter().string_to_resource(nsparamResponse.GetType(), response);
      ...
      nsparamArray[0] = resource.nsparam;
      return (base_resource[]) nsparamArray;
    }

    internal override string get_object_name() => (string) null;

    public static base_response update(nitro_service client, nsparam resource) => new nsparam()
    {
      ...
      internaluserlogin = resource.internaluserlogin,
      aftpallowrandomsourceport = resource.aftpallowrandomsourceport,
      icaports = resource.icaports,
      tcpcip = resource.tcpcip,
      servicepathingressvlan = resource.servicepathingressvlan
    ...
    public static base_response unset(
      ...
      string[] args)
    {
      return new nsparam().unset_resource(client, args);
    }

    public static nsparam get(nitro_service service) => ((nsparam[]) new nsparam().get_resources(service, (options) null))[0];

    public static nsparam get(nitro_service service, options option) => ((nsparam[]) new nsparam().get_resources(service, option))[0];

    private class nsparam_response : base_response
    {
      public nsparam nsparam = (nsparam) null;
    }
    ...
    public static class tcpcipEnum
    {
      public const string ENABLED = "ENABLED";
      public const string DISABLED = "DISABLED";
    }

    public static class aftpallowrandomsourceportEnum
    {
      public const string ENABLED = "ENABLED";
      public const string DISABLED = "DISABLED";
    }
    ...
    public static class internaluserloginEnum
    {
      public const string ENABLED = "ENABLED";
      public const string DISABLED = "DISABLED";
    }
