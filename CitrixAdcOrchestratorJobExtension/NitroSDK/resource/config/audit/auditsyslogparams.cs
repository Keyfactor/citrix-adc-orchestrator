...
// Type: com.citrix.netscaler.nitro.resource.config.audit.auditsyslogparams
...
{
  public class auditsyslogparams : base_resource
  {
    ...
    internal override base_resource[] get_nitro_response(
      ...
      string response)
    {
      auditsyslogparams[] auditsyslogparamsArray = new auditsyslogparams[1];
      auditsyslogparams.auditsyslogparams_response auditsyslogparamsResponse = new auditsyslogparams.auditsyslogparams_response();
      auditsyslogparams.auditsyslogparams_response resource = (auditsyslogparams.auditsyslogparams_response) service.get_payload_formatter().string_to_resource(auditsyslogparamsResponse.GetType(), response);
      ...
      auditsyslogparamsArray[0] = resource.auditsyslogparams;
      return (base_resource[]) auditsyslogparamsArray;
    }
    ...
    public static base_response update(
      ...
      auditsyslogparams resource)
    {
      return new auditsyslogparams()
      {
    ...
    public static base_response unset(
      ...
      string[] args)
    {
      return new auditsyslogparams().unset_resource(client, args);
    }

    public static auditsyslogparams get(nitro_service service) => ((auditsyslogparams[]) new auditsyslogparams().get_resources(service, (options) null))[0];

    public static auditsyslogparams get(nitro_service service, options option) => ((auditsyslogparams[]) new auditsyslogparams().get_resources(service, option))[0];

    private class auditsyslogparams_response : base_response
    {
      public auditsyslogparams auditsyslogparams = (auditsyslogparams) null;
    }
