...
// Type: com.citrix.netscaler.nitro.resource.config.basic.server_gslbservice_binding
...
{
  public class server_gslbservice_binding : base_resource
  {
    ...
    internal override base_resource[] get_nitro_response(
      ...
      string response)
    {
      server_gslbservice_binding.server_gslbservice_binding_response gslbserviceBindingResponse = new server_gslbservice_binding.server_gslbservice_binding_response();
      server_gslbservice_binding.server_gslbservice_binding_response resource = (server_gslbservice_binding.server_gslbservice_binding_response) service.get_payload_formatter().string_to_resource(gslbserviceBindingResponse.GetType(), response);
      ...
      return (base_resource[]) resource.server_gslbservice_binding;
    }

    internal override string get_object_name() => this.name;

    public static server_gslbservice_binding[] get(
      nitro_service service,
      string name)
    {
      return (server_gslbservice_binding[]) new server_gslbservice_binding()
      {
        name = name
      }.get_resources(service, (options) null);
    }

    public static server_gslbservice_binding[] get_filtered(
      nitro_service service,
      string name,
      string filter)
    {
      server_gslbservice_binding gslbserviceBinding = new server_gslbservice_binding();
      gslbserviceBinding.name = name;
      options option = new options();
      option.set_filter(filter);
      return (server_gslbservice_binding[]) gslbserviceBinding.getfiltered(service, option);
    }
    ...
    public static uint count(nitro_service service, string name)
    {
      ...
      server_gslbservice_binding[] resources = (server_gslbservice_binding[]) gslbserviceBinding.get_resources(service, option);
    ...
    public static uint count_filtered(nitro_service service, string name, string filter)
    {
      ...
      option.set_count(true);
      option.set_filter(filter);
      server_gslbservice_binding[] gslbserviceBindingArray = (server_gslbservice_binding[]) gslbserviceBinding.getfiltered(service, option);
    ...
    private class server_gslbservice_binding_response : base_response
    {
      public server_gslbservice_binding[] server_gslbservice_binding = (server_gslbservice_binding[]) null;
    }
