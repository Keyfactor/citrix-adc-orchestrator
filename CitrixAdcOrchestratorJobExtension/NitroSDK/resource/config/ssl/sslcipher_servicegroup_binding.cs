...
// Type: com.citrix.netscaler.nitro.resource.config.ssl.sslcipher_servicegroup_binding
...
{
  public class sslcipher_servicegroup_binding : base_resource
  {
    ...
    internal override base_resource[] get_nitro_response(
      ...
      string response)
    {
      sslcipher_servicegroup_binding.sslcipher_servicegroup_binding_response servicegroupBindingResponse = new sslcipher_servicegroup_binding.sslcipher_servicegroup_binding_response();
      sslcipher_servicegroup_binding.sslcipher_servicegroup_binding_response resource = (sslcipher_servicegroup_binding.sslcipher_servicegroup_binding_response) service.get_payload_formatter().string_to_resource(servicegroupBindingResponse.GetType(), response);
      ...
      return (base_resource[]) resource.sslcipher_servicegroup_binding;
    }

    internal override string get_object_name() => this.ciphergroupname;

    private class sslcipher_servicegroup_binding_response : base_response
    {
      public sslcipher_servicegroup_binding[] sslcipher_servicegroup_binding = (sslcipher_servicegroup_binding[]) null;
    }
