...
// Type: com.citrix.netscaler.nitro.resource.config.ssl.sslservice_sslcertkey_binding
...
{
  public class sslservice_sslcertkey_binding : base_resource
  {
    ...
    internal override base_resource[] get_nitro_response(
      ...
      string response)
    {
      sslservice_sslcertkey_binding.sslservice_sslcertkey_binding_response sslcertkeyBindingResponse = new sslservice_sslcertkey_binding.sslservice_sslcertkey_binding_response();
      sslservice_sslcertkey_binding.sslservice_sslcertkey_binding_response resource = (sslservice_sslcertkey_binding.sslservice_sslcertkey_binding_response) service.get_payload_formatter().string_to_resource(sslcertkeyBindingResponse.GetType(), response);
      ...
      return (base_resource[]) resource.sslservice_sslcertkey_binding;
    }
    ...
    public static base_response add(
      ...
      sslservice_sslcertkey_binding resource)
    {
      return new sslservice_sslcertkey_binding()
      {
    ...
    public static base_responses add(
      nitro_service client,
      sslservice_sslcertkey_binding[] resources)
    {
      base_responses baseResponses = (base_responses) null;
      if (resources != null && resources.Length > 0)
      {
        sslservice_sslcertkey_binding[] sslcertkeyBindingArray = new sslservice_sslcertkey_binding[resources.Length];
        for (int index = 0; index < resources.Length; ++index)
        {
          sslcertkeyBindingArray[index] = new sslservice_sslcertkey_binding();
          sslcertkeyBindingArray[index].servicename = resources[index].servicename;
    ...
    public static sslservice_sslcertkey_binding[] get(
      nitro_service service,
      string servicename)
    {
      return (sslservice_sslcertkey_binding[]) new sslservice_sslcertkey_binding()
      {
        servicename = servicename
      }.get_resources(service, (options) null);
    }

    public static sslservice_sslcertkey_binding[] get_filtered(
      nitro_service service,
      string servicename,
      string filter)
    {
      sslservice_sslcertkey_binding sslcertkeyBinding = new sslservice_sslcertkey_binding();
      sslcertkeyBinding.servicename = servicename;
      options option = new options();
      option.set_filter(filter);
      return (sslservice_sslcertkey_binding[]) sslcertkeyBinding.getfiltered(service, option);
    }
    ...
    public static uint count(nitro_service service, string servicename)
    {
      ...
      sslservice_sslcertkey_binding[] resources = (sslservice_sslcertkey_binding[]) sslcertkeyBinding.get_resources(service, option);
    ...
    public static uint count_filtered(nitro_service service, string servicename, string filter)
    {
      ...
      option.set_count(true);
      option.set_filter(filter);
      sslservice_sslcertkey_binding[] sslcertkeyBindingArray = (sslservice_sslcertkey_binding[]) sslcertkeyBinding.getfiltered(service, option);
    ...
    private class sslservice_sslcertkey_binding_response : base_response
    {
      public sslservice_sslcertkey_binding[] sslservice_sslcertkey_binding = (sslservice_sslcertkey_binding[]) null;
    }
